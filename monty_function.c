...
/**
 * read_file - reads a bytcode file and runs commands in file
...
/**
 * get_op_func - checks opcode and returns the corresponding function
 * @str: the opcode
 * Return: the function
 */
...
/**
 * parse_line - parses a file line for opcode and arguments
 * @line: the line to be read and parsed
